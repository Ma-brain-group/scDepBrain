#!/bin/bash
# ============================================================
# MAGMA gene-based analysis for PGC 2025 Trans-ancestry (DIV) GWAS
# Following user's reference pipeline:
#   - window = 50,50 (±50 kb)
#   - --gene-loc extendedMHCexcluded
#   - --pval ncol=N (per-SNP NEFF)
#
# Inputs:  pgc-mdd2025_no23andMe_div_v3-49-46-01.tsv.gz
# Outputs (in EUR/):
#   pgc2025_div.snp_loc      (SNP CHR BP)
#   pgc2025_div.pval         (SNP P N)   N = NEFF column
#   pgc2025_div.genes.annot  (annotation step)
#   pgc2025_div.genes.raw    (gene-based output, used downstream)
# ============================================================
#SBATCH -J magma_div_pp
#SBATCH -p defq
#SBATCH -A hpcusers
#SBATCH -c 2
#SBATCH --mem=32G
...
GWAS_IN=$PROJ/MDD_2025_Cell_GWAS_summary/pgc-mdd2025_no23andMe_div_v3-49-46-01.tsv.gz

SNP_LOC=$OUT/pgc2025_div.snp_loc
PVAL=$OUT/pgc2025_div.pval
ANNOT_PREFIX=$OUT/pgc2025_div.annot
GENES_PREFIX=$OUT/pgc2025_div
