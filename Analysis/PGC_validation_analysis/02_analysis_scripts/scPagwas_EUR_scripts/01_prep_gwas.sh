#!/bin/bash
# ============================================================
# Convert PGC MDD 2025 (EUR ancestry, no 23andMe) GWAS sumstats
...
#SBATCH --mem=4G
#SBATCH -t 00:30:00
#SBATCH -o /mnt/isilon/gandal_lab/mayl/07_scDepBrain/results_scPagwas_MDD2025_EUR_20260610/slurm-%j.out
#SBATCH -e /mnt/isilon/gandal_lab/mayl/07_scDepBrain/results_scPagwas_MDD2025_EUR_20260610/slurm-%j.err

set -euo pipefail
PROJ=/mnt/isilon/gandal_lab/mayl/07_scDepBrain
DATA=$PROJ/MDD_2025_Cell_GWAS_summary
OUT=$PROJ/results_scPagwas_MDD2025_EUR_20260610
GWAS_IN=$DATA/pgc-mdd2025_no23andMe_eur_v3-49-24-11.tsv.gz
GWAS_OUT=$OUT/pgc-mdd2025_eur_scPagwas_input.txt
