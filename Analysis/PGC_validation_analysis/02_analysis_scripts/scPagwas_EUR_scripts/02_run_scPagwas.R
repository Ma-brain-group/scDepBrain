...
GWAS    <- file.path(OUT, "pgc-mdd2025_eur_scPagwas_input.txt")
RDS_OUT <- file.path(OUT, "MDD_scPagwas_PGC2025_EUR_v2026.rds")
PREFIX  <- "MDD_PGC2025_EUR_v2026"
...
# ---- Run scPagwas ----
cat("[", as.character(Sys.time()), "] Starting scPagwas_main2 (PGC 2025 EUR) ...\n")
t1 <- Sys.time()
